...
<script src="/goodsManage/Public/js/Admin/outorder.js"></script>
<script>
	(function($){
...
<header>
 ...
 <ul class="rt_nav">
  ...
  <li><a href="/goodsManage/index.php/Admin/Outorder/doLogout" class="quit_icon">安全退出</a></li>
 </ul>
</header>
...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
     ...
     <section>
      <h2><strong style="color:grey;">添加出库单</strong></h2>
      <ul class="ulColumn2">
       <li>
